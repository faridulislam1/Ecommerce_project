                    ...
                    <form class="form-horizontal p-t-20" action="{{route('unit.update',['id'=>$unit->id])}}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="exampleInputEmail3" name="description" placeholder="Unit Description">{{$unit->description}}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputPassword4" class="col-sm-3 control-label">Publication Status</label>
                                <div class="col-sm-9">
                                    <label class="me-3"> <input  type="radio" {{$unit->status == 1 ? 'checked' : ''}} value="1" name="status" checked> Published</label>
                                    <label> <input  type="radio" value="2"  {{$unit->status == 2 ? 'checked' : ''}} name="status"> UnPublished</label>
                                </div>
                            </div>
